...
def uas(ganti):
    if ganti == '':
        ...
        Console(width=80, style="bold hot_pink2").print(Panel("""Ketik cancel untuk gunakan ua dari script""",subtitle="╭───", subtitle_align="left",title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (SETTING) [bold green]<[bold yellow]<[bold red]<"))
